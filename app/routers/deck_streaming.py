...
from app.services.openai_service import llm_request_context
import json
import asyncio
import logging
        ...
        try:
            with llm_request_context(request.aiProvider, request.aiModel):
                ...
                for i, slide_plan in enumerate(outline):
                    ...
                    slide_type = slide_plan.get('type') or slide_plan.get('slideType')
                    if 'title' not in slide_plan or not slide_type:
                        continue
